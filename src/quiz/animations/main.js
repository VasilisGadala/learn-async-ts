        ...
        return __generator(this, function (_a) {
            if (alice10 && alice20 && alice30) {
                return [2 /*return*/, new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
                        var alice10_finished, alice20_finished, alice30_finished, error_1;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    _a.trys.push([0, 4, , 5]);
...
renderAlice().then(function (res) { return console.log(res); }).catch(console.error);
// alice10
